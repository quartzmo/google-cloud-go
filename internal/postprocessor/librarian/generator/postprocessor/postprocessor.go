...
func PostProcess(ctx context.Context, req *request.Request, importPath, outputDir string) error {
	...
	if len(req.APIs) > 0 {
		...
		if err := goModInit(ctx, importPath, outputDir); err != nil {
...
func goModInit(ctx context.Context, importPath, outputDir string) error {
